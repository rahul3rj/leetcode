...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/valid-parenthesis-string/)
...
**My Solution:** [678-Valid-Parenthesis-String.java](./678-Valid-Parenthesis-String.java)
