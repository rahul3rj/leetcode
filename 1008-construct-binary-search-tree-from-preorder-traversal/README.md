...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/construct-binary-search-tree-from-preorder-traversal/)
...
**My Solution:** [1008-Construct-Binary-Search-Tree-from-Preorder-Traversal.java](./1008-Construct-Binary-Search-Tree-from-Preorder-Traversal.java)
